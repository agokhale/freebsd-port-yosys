...
USES=		tar:xz gmake
BUILD_DEPENDS= 	gmake:devel/gmake  bison:devel/bison  flex:textproc/flex hg:devel/mercurial dot:graphics/graphviz python3:lang/python3 tclsh:lang/tcl-wrapper gcc:lang/gcc
